...
import protectionPlanningImage from "@/assets/protectionplanning.jpeg"
      ...
      <section className="pt-10 pb-6 md:pt-14 md:pb-8">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="overflow-hidden rounded-[2rem]">
            <img
              src={protectionPlanningImage}
              alt="A professional reviewing his financial plans at home"
        ...
        <div className="container mx-auto max-w-5xl px-4 space-y-12">
          ...
          <div className="border-t border-border/70">
            <div className="grid md:grid-cols-2">
              {protectionPlanningContent.review.items.map((item, index) => (
                <div
                  key={item.title}
                  className="border-b border-border/70 py-8 md:border-r md:px-8 md:py-10 first:md:pl-0 last:md:border-r-0"
                >
                  <div className="space-y-5">
